...
From the linear regression model above, we can estimate that about 33.53% of the variability in the response values are explained by the regression model. This suggest we have a weak to moderate model for explaining the variability.
