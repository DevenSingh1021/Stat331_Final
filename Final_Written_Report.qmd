...
From the animate plots we are able to see the relationship between Time and both GDP and Child Mortality. We can see within the graphs that as the year approaches 2025 Child Mortality decreases and GDP increases. This causes it to move slightly diagonally indicating there may be a relationship between Child Mortality and GDP over time.
